  ...
  return (
    <main className="container-standard pt-28 pb-12 sm:pb-20">
      ...
      <header className="mt-10 max-w-3xl border-b border-[var(--color-border)] pb-12">
        ...
        <h1 className="mt-4 text-4xl tracking-tight sm:text-6xl">{format.name} for private-label nutrition.</h1>
        <p className="mt-6 text-lg text-[var(--color-muted)]">{format.fit}. VITHELO reviews formula, format and packaging together before confirming a production route.</p>
      </header>
